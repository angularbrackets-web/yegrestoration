    ...
    extend: {
      colors: {
        ...
        yeg: {
          ...
          'amber-hover': '#f5d56a',
          text: '#F4F2ED',
          // Slightly brighter for long body copy on dark sections (was #A9B3C1)
          'text-secondary': '#B8C2CE',
          // High-contrast accent on light cream surfaces (pale gold failed WCAG)
          signal: {
            DEFAULT: '#C2410C',
            bright: '#E85D04',
          },
          // Readable accent on dark backgrounds (eyebrows, icons) without opacity tricks
          'signal-on-dark': '#FB923C',
          // Light surface tokens (StatsBar, ProcessSection)
          surface: '#f7f5f2',
          'on-surface': '#0f1419',
